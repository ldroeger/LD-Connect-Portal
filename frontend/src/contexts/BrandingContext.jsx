...
const BrandingContext = createContext({
  ...
  logo_url: '/default-logo.png', logo_mode: 'icon', favicon_url: '', banner_height: 48, calendar_range_days: 14, scroll_to_time: '08:00', cal_min_time: '06:00', cal_max_time: '22:00',
})
...
export function BrandingProvider({ children }) {
  const [branding, setBranding] = useState({
    company_name: 'LD Connect', primary_color: '#2563EB',
    logo_url: '/default-logo.png', logo_mode: 'icon', favicon_url: '', banner_height: 48, calendar_range_days: 14, scroll_to_time: '08:00', cal_min_time: '06:00', cal_max_time: '22:00', todo_archive_hours: 24,
  })
