...
export default function Layout() {
  ...
  const NavItems = ({ onNavigate }) => (
    <>
      {(features.calendar || features.vacation || features.hours) && (
      ...
      {features.calendar && <NavLink to="/" end style={({isActive})=>navLink(isActive)} onClick={onNavigate}><span>📅</span><span>Kalender</span></NavLink>}
