...
export default function ApptDetailPopup({ recno, labelColors = {}, label, termColor, screenToken, onClose, theme }) {
  ...
  return (
    <div style={{ position:'fixed', inset:0, padding:16, background:'rgba(0,0,0,0.6)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:2000 }} onClick={onClose}>
      <div style={{ background:bg, borderRadius:16, padding:24, maxWidth:900, width:'min(700px,94vw)', border:`1px solid ${border}`, boxShadow:'0 24px 64px rgba(0,0,0,0.4)' }} onClick={e=>e.stopPropagation()}>
