  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
      <div style={{ textAlign: 'center', maxWidth: 400 }}>
        ...
        <h2 style={{ marginBottom: 8, color: 'var(--text)' }}>{translate(lang,'no_access')}</h2>
        <p style={{ color: 'var(--text-3)', marginBottom: 24, fontSize: '0.9rem', lineHeight: 1.6 }}>
          {translate(lang,'no_access_text')}<br />
          {translate(lang,'no_access_contact')}
        </p>
        <button
          onClick={() => navigate('/')}
