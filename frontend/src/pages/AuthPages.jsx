    ...
    <div style={S.wrap}>
      ...
      <div style={S.card}>
        <div style={S.header}>
          ...
          <p style={S.subtitle}>LD Connect · {translate(lang,'login_title')}</p>
        </div>
        {error && <div style={S.error}>{error}</div>}
        <div style={S.field}>
          <label style={S.label}>{translate(lang,'login_email')}</label>
        ...
        <div style={S.field}>
          <label style={S.label}>{translate(lang,'login_password')}</label>
        ...
        <div style={S.forgotRow}><Link to="/forgot-password" style={S.link}>{translate(lang,'login_forgot')}</Link></div>
        <button style={S.btn} onClick={handleSubmit} disabled={loading}>{loading ? translate(lang,'loading') : translate(lang,'login_button')}</button>
      </div>
    </div>
  )
}
