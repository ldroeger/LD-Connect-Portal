...
function SmbTab() {
  ...
  const [docOwnCreds, setDocOwnCreds] = React.useState(false)
  const [docHost, setDocHost]         = React.useState('')
  const [docUser, setDocUser]         = React.useState('')
  const [docPass, setDocPass]         = React.useState('')
  const [docDomain, setDocDomain]     = React.useState('')
