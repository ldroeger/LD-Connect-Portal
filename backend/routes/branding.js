...
router.get('/', (_req, res) => res.json({
  ...
  todo_archive_hours:  parseInt(localDb.getSetting('todo_archive_hours') || '24'),
}));
...
router.put('/', adminMiddleware, (req, res) => {
  try {
    ...
    if (req.body.todo_archive_hours) localDb.setSetting('todo_archive_hours', String(req.body.todo_archive_hours));
